...
export function AiAssistantBanner({ userName, orgId }: AiAssistantBannerProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      >
        <Sparkles className="mr-3 h-5 w-5 shrink-0 text-indigo-500" aria-hidden />
        <input
          type="text"
          value={query}
        ...
        <button
          type="submit"
          className="ml-2 flex shrink-0 items-center justify-center gap-1.5 rounded-xl bg-indigo-600 px-4 py-2 text-xs font-semibold text-white shadow-sm transition-all hover:bg-indigo-700 active:scale-95"
        >
          Ask AI
